      ...
      <div class="row">
         <div class="col-md-12  ">
            <div class="x_panel">
               <div class="x_content">
                  <br />
                  <form class="form-horizontal form-label-left" action="{{ route('answers.update',$answer->id) }}" method="POST">
                       @csrf
                       @method('PUT')
                     ...
                     <div class="form-group row ">
                        ...
                        <div class="col-md-9 col-sm-9 ">
                           Yes
                           <input type="radio" class="" name="correct_answer" @if($answer->correct_answer == 1) checked @endif  value="1" required>
                           No
                           <input type="radio" class="" name="correct_answer" @if($answer->correct_answer == 2) checked @endif value="2" required>
                        </div>
                     </div>
                     <div class="form-group row">
